...
╚═╝     ╚═╝ ╚═════╝ ╚═╝  ╚═══╝╚══════╝   ╚═╝   ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝     ╚═╝  ╚═╝
        ...
        ****************************************************************************
        *| "MuhammedWebScript" Web Applications Security Scanner                   *
        *|  By Monsteralpa    - alpabilge11@gmail.com                              *
        *|  This Version Supports Remote Code/Command Execution, XSS               *
        *|  And SQL Injection.                                                     *
	*|  More Details: https://www.youtube.com/channel/UC7Dx9EwDvYqMpokrCXM8P_Q *
        ****************************************************************************
        '''+ga.end
